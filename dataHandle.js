...
// user数据统计出销售额
// let data1 = JSON.parse(fs.readFileSync('/Users/lmlc/Desktop/user2.json', 'utf-8'));
// let total1=0;
// len1=data1.length;
...
// user数据按照产品分类统计
fs.readFile('/Users/lmlc/Desktop/user2.json', 'utf-8', function(err, data){
	...
	fs.writeFileSync('/Users/lmlc/Desktop/user5.json', JSON.stringify(out));
...
// 根据起止时间筛选部分user数据
// let data = JSON.parse(fs.readFileSync('/Users/lmlc/Desktop/user.json', 'utf-8'));
// let start, end;
...
// fs.writeFile('/Users/lmlc/Desktop/user3.json', JSON.stringify(data.slice(start, end)), (err) => {
//     if (err) throw err;
//     console.log('筛选完成');
// });


// fs.readFile('/Users/lmlc/Desktop/product2.json', 'utf-8', function(err, data){
// 	if (err) throw err;
// 	let data2 = JSON.parse(data);
// 	fs.writeFile('/Users/lmlc/Desktop/product3.json', JSON.stringify(data2.slice(0, 5)), (err) => {
// 	    if (err) throw err;
...
fs.readFile('/Users/lmlc/Desktop/product2.json', 'utf-8', function(err, data){
	...
	fs.writeFileSync('/Users/lmlc/Desktop/product5.json', JSON.stringify(out));
